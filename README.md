...
> - vi) On top right corner, choose "Install" then on "Plug into this computer" to compile the firmware. It can be a long processus !!!. Wait a couple of minutes (it first compile the code at background during 3-4min) then it starts the flashing part. You should see a progression bar running when flashing.
