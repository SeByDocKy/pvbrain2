...
> - iv) On ESPhome Dashboard, click first on "secret" button located at the top right corner. Replace "xxxxxxxx", "yyyyyyyy" and "zzzzzzzz" with your own WiFi SSID/password and AP informations. Be aware, WiFi password must be a minimum of 8 caractars. If not, you will need to change your WiFi password correspondly. Click on "save" and quit the secret page by clicking on the top left cross.
