...
> - [![Static Badge](https://img.shields.io/badge/DrCoolZic-black?logo=git&style=flat)](https://github.com/DrCoolzic) (Expansion cards [WK2132](https://www.dfrobot.com/product-2001.html) and [WK2168](../main/pictures/top%20side%20WK2168.png) ).
> 
...
Please find all Gerber files required for the PCB in the following folder:
...
| Front                     | Back                      |
| :-----------------------: | :-----------------------: |
| <img src="../main/hardware/module_wk_2168/wk_2168_front.png" width="1068" /> | <img src="../main/hardware/module_wk_2168/wk_2168_back.png" width="1068" /> |
| 3D View                   | Circuit                   |
|<img src="../main/hardware/module_wk_2168/wk_2168_3d_view.png" width="1068" /> | <img src="../main/hardware/module_wk_2168/wk_2168_circuit.png" width="1068" /> |
| Schematic                 |
| :-----------------------: |
|<img src="../main/hardware/module_wk_2168/wk2168_schematic.png" width="480" /> |

## WK 2132
Before discovering the WK2168 module which allowed the creation of the card above, a DIY version of the DFR0627 had been designed. Its cost is a little lower than its big brother the WK2168, but it only allows two additional UARTs.
| 3D View                   |
| :-----------------------: |
|<img src="../main/hardware/module_wk_2132/wk2132_schematic.png" width="480" /> |

## UART Isolator
TTL isolator, originally designed for VictronVE direct.
- With the participation of [![Static Badge](https://img.shields.io/badge/Luc-black?logo=discord&style=flat)], [![Static Badge](https://img.shields.io/badge/Ju__Workshop-black?logo=discord&style=flat)] and [![Static Badge](https://img.shields.io/badge/Cristof48-black?logo=discord&style=flat)] of the [![Static Badge](https://img.shields.io/badge/DISCORD-Reseautonome-black?style=social&logo=discord)](https://reseautono.me/).
| Front                     | Back                      |
| :-----------------------: | :-----------------------: |
| <img src="../main/hardware/module_uart_isolator/uart_isolator_front.png" width="1068" /> | <img src="../main/hardware/module_uart_isolator/uart_isolator_back.png" width="1068" /> |
| 3D View                   | Circuit                   |
|<img src="../main/hardware/module_uart_isolator/uart_isolator_3d_view.png" width="1068" /> | <img src="../main/hardware/module_uart_isolator/uart_isolator_circuit.png" width="1068" /> |
| Schematic                 |
| :-----------------------: |
|<img src="../main/hardware/module_uart_isolator/uart_isolator_schematic.png" width="480" /> |
...
| Front                     | Back                      |
| :-----------------------: | :-----------------------: |
| <img src="../main/hardware/addon_uart_extension/uart_extension_front.png" width="1068" /> | <img src="../main/hardware/addon_uart_extension/uart_extension_back.png" width="1068" /> |
| 3D View                   | Circuit                   |
|<img src="../main/hardware/addon_uart_extension/uart_extension_3d_view.png" width="1068" /> | <img src="../main/hardware/addon_uart_extension/uart_extension_circuit.png" width="1068" /> |
...
| Front                     | Back                      |
| :-----------------------: | :-----------------------: |
| <img src="../main/hardware/addon_pv_monitor/pv_monitor_front.png" width="1068" /> | <img src="../main/hardware/addon_pv_monitor/pv_monitor_back.png" width="1068" /> |
| 3D View                   | Circuit                   |
|<img src="../main/hardware/addon_pv_monitor/pv_monitor_3d_view.png" width="1068" /> | <img src="../main/hardware/addon_pv_monitor/pv_monitor_circuit.png" width="1068" /> |
...
Link to the Github Page: [![Static Badge](https://img.shields.io/badge/Dackara-Clamp__Meter-black?style=social&logo=quasar)](https://github.com/Dackara/Clamp_Meter) (Still in development)

| Front                     | Back                      |
| :-----------------------: | :-----------------------: |
| <img src="../main/hardware/addon_clamp_meter/clamp_meter_front.png" width="1068" /> | <img src="../main/hardware/addon_clamp_meter/clamp_meter_back.png" width="1068" /> |
| 3D View                   | Circuit                   |
|<img src="../main/hardware/addon_clamp_meter/clamp_meter_3d_view.png" width="1068" /> | <img src="../main/hardware/addon_clamp_meter/clamp_meter_circuit.png" width="1068" /> |
...
| :-----------------------: | :-----------------------: |
| ![alt text](../main/Hardware/printable_3d_din_mount/3d_din_mount_front.png) | ![alt text](../main/Hardware/printable_3d_din_mount/3d_din_mount_back.png) |

## "Carte Option 2":
The old "Option 2" card made by [![Static Badge](https://img.shields.io/badge/Luc-black?logo=discord&style=flat)] for the [PVbrain V1](https://github.com/Bandit-17/PVBRAIN) is also compatible with the PVbrain V2.
